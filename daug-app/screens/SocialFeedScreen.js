...
import { StyleSheet, Text, View, Image,ScrollView, FlatList, TouchableOpacity , Alert, DeviceEventEmitter, ActivityIndicator} from 'react-native';
import { SOCIAL_FEED_MOCK_DATA } from '../assets/SOCIAL_FEED_MOCK_DATA';
import { Ionicons } from '@expo/vector-icons';
import { SimpleLineIcons } from '@expo/vector-icons';
import { Font } from 'expo';
import COVER from '../assets/Cover.png'
import { ENV_URL, getUserId } from '../util/helper';
...
export default class SocialFeedScreen extends React.Component {
  ...
  async fetchUser() {
     ...
     <View style = { styles.itemContainer}>
        ...
        <View style={styles.nameLocationContainer}>
         <TouchableOpacity style = {styles.nameContainer}
            onPress={() => navigate('Profile',{ isHeaderShow: true, userId: post.user.id })}
         >
    ...
    <TouchableOpacity  onPress={() => navigate('Post',{ postId: post.id})} >
